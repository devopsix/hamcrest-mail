...
public class MailMatchersTest {
  ...
  public void hasHeadersWithMatcherShouldReturnMatcher() {
    ...
    Matcher<Part> matcher =
        MailMatchers.hasHeaders("Received", hasItems(any(String.class), any(String.class)));
    assertThat(matcher, is(notNullValue()));
    assertThat(message, matcher);
  }
  ...
  public void hasDateHeadersWithMatcherShouldReturnMatcher() {
    Message message = createTextMessage();
    Matcher<Part> matcher = MailMatchers.hasDateHeaders("Other-Date",
        hasItems(any(OffsetDateTime.class), any(OffsetDateTime.class)));
    assertThat(matcher, is(notNullValue()));
    assertThat(message, matcher);
  }
  ...
  public void hasValidDkimSignatureShouldReturnMatcher() {
    ...
    Map<String, String> publicKeys =
        singletonMap("foo._domainkey.example.com", "k=rsa; p=" + publicKey);
