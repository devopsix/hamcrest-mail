...
public class MessageFileExampleTest {
  ...
  public void messageShouldHaveReceivedHeaders() {
    ...
    assertThat(message,
        hasHeaders("Received", (Matcher) everyItem(anyOf(startsWith("from "), startsWith("by ")))));
    assertThat(message, hasHeaders("Received",
        hasItems(containsString("mail-tester.com"), containsString("google.com"))));
  }
  ...
  public void messageShouldHaveMultipartContent() {
    ...
    assertThat(message,
        hasMultipartContent(is(multipartContentType(startsWith("multipart/mixed;")))));
