...
public final class MailMatchers {
   ...
   * @throws NullPointerException when {@code matcher} is {@code null}
   */
  public static Matcher<Message> hasRecipients(RecipientType type,
                                               Matcher<Iterable<Address>> matcher) {
    requireNonNull(matcher);
   ...
   * @throws NullPointerException when {@code header} is {@code null} or {@code matcher}
   *                              is {@code null}
   */
   ...
   * @param value  The expected header value
   * @return A matcher for a {@link Part}
   * @throws NullPointerException when {@code header} is {@code null} or {@code value}
   *                              is {@code null}
   */
   ...
   *                              is {@code null}
   */
  public static Matcher<Part> hasDateHeaders(String header,
