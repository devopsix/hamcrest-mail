...
public class MailDateTimeFormatterTest {
    ...
    public void shouldAcceptMissingDay() {
        OffsetDateTime date = OffsetDateTime.parse("1 Dec 2019 14:49:44 +0100", MailDateTimeFormatter.MAIL_DATE_TIME);
        assertThat(date, notNullValue());
        assertThat(date.getYear(), is(2019));
    }
    ...
    public void shouldTrimTrailingZoneText() {
        assertThat(trimTrailingZoneText("Sun, 1 Dec 2019 14:49:44 +0100"), is("Sun, 1 Dec 2019 14:49:44 +0100"));
        assertThat(trimTrailingZoneText("Sun, 1 Dec 2019 14:49:44 +0100 (CET)"), is("Sun, 1 Dec 2019 14:49:44 +0100"));
        assertThat(trimTrailingZoneText("Sun, 14 Jun 2020 16:05:08 +0200 (CEST)"), is("Sun, 14 Jun 2020 16:05:08 +0200"));
    }
}
